...
public abstract class BaseBizCardOcr {
...
//            String base64 = openCVService.correct(base64Img);
			...
			// 不过滤部分颜色
			// bufferedImage = ImageFilter.imageRGBDifferenceFilter(bufferedImage,
			// targetDifferenceValue, null);
			...
			getBufferedNameImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/nameImageBefore.jpg"));
			getBufferedCapitalImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/capitalImageBefore.jpg"));
			getBufferedBizTypeImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/bizTypeImageBefore.jpg"));
			getBufferedBuildOnImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/buildOnImageBefore.jpg"));
			getBufferedJuridicalImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/juridicalImageBefore.jpg"));
			getBufferedBizLimitImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/bizLimitImageBefore.jpg"));
			getBufferedBizScopeImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/bizScopeImageBefore.jpg"));
			getBufferedAddressImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/addressImageBefore.jpg"));
			getBufferedCreditCodeImage(tesseract, bufferedImage, bizLicenseInfo,
					getImgPath(outPartImg, "/creditCodeImageBefore.jpg"));
	 ...
	 */
	private void getBufferedCreditCodeImage(Tesseract tesseract, BufferedImage bufferedImage,
			BizLicenseInfo bizLicenseInfo, String path) throws TesseractException {
		try {
	 ...
	 * @param path
	 */
	private void getBufferedNameImage(Tesseract tesseract, BufferedImage bufferedImage, BizLicenseInfo bizLicenseInfo,
	 ...
	 * @throws TesseractException
	 */
	private void getBufferedBizTypeImage(Tesseract tesseract, BufferedImage bufferedImage,
			BizLicenseInfo bizLicenseInfo, String path) throws Exception {
	 ...
	 * @throws TesseractException
	 */
	private void getBufferedJuridicalImage(Tesseract tesseract, BufferedImage bufferedImage,
			BizLicenseInfo bizLicenseInfo, String path) throws Exception {
	 ...
	 * @throws TesseractException
	 */
	private void getBufferedBizScopeImage(Tesseract tesseract, BufferedImage bufferedImage,
			BizLicenseInfo bizLicenseInfo, String path) throws Exception {
	 ...
	 * @throws TesseractException
	 */
	private void getBufferedCapitalImage(Tesseract tesseract, BufferedImage bufferedImage,
			BizLicenseInfo bizLicenseInfo, String path) throws Exception {
	 ...
	 * @throws TesseractException
	 */
	private void getBufferedBuildOnImage(Tesseract tesseract, BufferedImage bufferedImage,
			BizLicenseInfo bizLicenseInfo, String path) throws Exception {
	 ...
	 * @throws TesseractException
	 */
	private void getBufferedBizLimitImage(Tesseract tesseract, BufferedImage bufferedImage,
			BizLicenseInfo bizLicenseInfo, String path) throws Exception {
	 ...
	 * @throws TesseractException
	 */
	private void getBufferedAddressImage(Tesseract tesseract, BufferedImage bufferedImage,
			BizLicenseInfo bizLicenseInfo, String path) throws Exception {
	 ...
	 * @param consumer
	 */
	private void getBufferedImage(Tesseract tesseract, BufferedImage buffered, String path,
			BiConsumer<BufferedImage, String> consumer) throws Exception {
		...
		String content = result.replaceAll(regexStr, "").replaceAll("\\n", "").replaceAll(" ", "");
		if (consumer != null) {
