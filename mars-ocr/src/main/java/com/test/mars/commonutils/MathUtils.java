...
public class MathUtils {
	...
	/**
	 * 把opencv的灰度图Mat转化为List<List<Double>> , 即数组对象 List<Double>是每一列的灰度值
	 * 
	 * @param gray
	 * @return
	 */
	...
	public static List<Double> avgColMat(Mat grayMat) {
		return avgColMat(grayMat, Boolean.FALSE);
	}
	
	public static List<Double> avgColMat(Mat grayMat,boolean isOne) {
	...
	public static List<Double> avgRowMat(Mat grayMat,boolean isOne) {
